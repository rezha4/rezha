...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid max-h-10 gap-2 p-3 select-none relative"
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(87, 212, 101);
            --purple-glow: rgba(87, 212, 101);
            --purple-border: rgba(87, 212, 101);
          }
